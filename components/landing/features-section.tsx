...
const features = [
  {
    ...
    description: "AI-powered websites engineered to maximize conversions and user engagement. Dynamic content personalization with real-time optimization.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "AI Lead Capture Systems",
    description: "Intelligent lead capture systems that qualify and nurture prospects automatically. Smart scoring and personalized follow-up sequences.",
    visual: "ai",
  },
  {
    number: "03",
    title: "AI Chat Sales Assistants",
    description: "Custom chatbots trained on your business to drive sales 24/7. Natural conversations with smart product recommendations.",
    visual: "collab",
  },
  {
    number: "04",
    title: "SaaS / Web App Development",
    description: "Full-stack web applications built for scale with modern architecture. From MVP to enterprise platforms.",
    visual: "security",
  },
];
