...
const testimonials = [
  {
    quote: "The ROI-first approach changed how we view our digital spend. Traffic doubled in 3 months!",
    author: "Alex Rivera",
    role: "CEO",
    company: "TechFlow",
    metric: "+248% user growth",
  },
  {
    quote: "Incredible speed performance. Our bounce rate dropped by 45% since the redesign.",
    author: "Sarah Chen",
    role: "Founder",
    company: "Bloom Media",
    metric: "45% bounce reduction",
  },
  {
    quote: "A professional team that understands business goals, not just pretty designs.",
